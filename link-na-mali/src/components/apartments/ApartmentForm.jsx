  ...
  return (
    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 text-black">
      <input
        ...
        className="px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-var(--secondary-color) bg-white"
      />
      <input
        type="text"
        value={location}
      ...
      <textarea
        ...
        className="px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-var(--secondary-color) col-span-3 h-32 resize-none bg-white"
      />
